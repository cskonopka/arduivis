...
,
						...
						"boxes" : [ 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 0.0, 0.0, 603.0, 474.0 ],
									"presentation" : 1,
									"presentation_linecount" : 37,
									"presentation_rect" : [ 126.173813, 33.686386, 209.0, 916.0 ],
									"style" : "",
									"text" : "instructions\n\n1) Upload the arduino sketch associated with this example. \n\"arduivis_bluetooth.ino\"\n\n2) Next, pair the bluetooth module with the computer. (note: pairing password: 1234). This process only need to be done once. From this point on, the new device will be found as an optional serial port in Max. \n\n2) Open the max patch. \n\"arduivis_bluetooth_hc06.maxpat\"\n\n3) Update the serial ports and select the bluetooth module. \n\n4) Once the module is selected, wait a 2-3 seconds and then click start. This will start the flow of data from the module to Max\n\n5) After the connection is made, the output of the module will be visualized in the patch. ",
									"textjustification" : 1
								}
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 15.333336, 15.258057, 425.21228, 39.0 ],
					"style" : "",
					"text" : "arduivis: bluetooth - hc06/hc05",
					"textjustification" : 1
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 42.642426, 500.625244, 160.0, 22.0 ],
					"style" : "",
					"text" : "prepend set From-Bluetooth"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 42.642426, 528.86499, 136.0, 50.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 272.878967, 251.374268, 163.0, 28.0 ],
					"style" : "",
					"text" : "From-Bluetooth 1778",
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 111.840477, 117.108368, 232.378082, 39.0 ],
					"style" : "",
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 20.180077, 251.374268, 415.698883, 83.177277 ],
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 15.333334, 112.479965, 425.21228, 227.071579 ],
					"proportion" : 0.39,
					"rounded" : 4,
					"style" : ""
				}
