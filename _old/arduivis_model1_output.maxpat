...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 359.275146, 339.002197, 525.974365, 31.0 ],
					"text" : "sketch: arduivis_model1_output.ino",
					"textjustification" : 1
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 359.275146, 378.33551, 525.974365, 129.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "bang" ],
					"patching_rect" : [ 247.585449, 174.026917, 104.659729, 21.0 ],
					"text" : "qmetro 50"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "bang" ],
					"patching_rect" : [ 378.761597, 151.593719, 60.0, 20.0 ],
					"text" : "loadbang"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 378.761597, 171.593719, 113.0, 18.0 ],
					"text" : "pic arduivis_led.jpg"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 365.761566, 112.219879, 243.000031, 192.544067 ],
					"pic" : "arduivis_led.jpg"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 359.761597, 63.593719, 525.487915, 27.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 359.761597, 6.275856, 525.487915, 56.0 ],
					"text" : "arduivis\t",
					"textjustification" : 1
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 148.723633, 428.24707, 23.0, 28.0 ],
					"text" : "3",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 12.72364, 403.24707, 165.0, 20.0 ],
					"text" : "prepend set"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 12.72364, 428.24707, 74.806465, 39.0 ],
					"text" : "OFF",
					"textcolor" : [ 0.99024, 0.995289, 0.990099, 1.0 ],
					"textjustification" : 1
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 12.72364, 467.24707, 159.0, 50.0 ],
					"text" : "output \n(data from arduino)",
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 12.72364, 425.24707, 159.0, 96.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 359.275146, 96.491913, 261.000031, 236.0 ],
					"rounded" : 10
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 359.275146, 63.593719, 525.974365, 28.990128 ],
					"rounded" : 10
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 359.275146, 374.058258, 525.974365, 137.554474 ],
					"rounded" : 10
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 359.761597, 9.665466, 525.487915, 49.220779 ],
					"rounded" : 10
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 359.275146, 336.002197, 525.974365, 34.0 ],
					"rounded" : 10
				}
		...
		"lines" : [ 			{
				"patchline" : 				{
					...
					"disabled" : 0,
					"hidden" : 0,
					"midpoints" : [ 22.22364, 426.797302, 22.22364, 426.797302 ],
					"source" : [ "obj-110", 0 ]
				}
...
,
		"dependency_cache" : [ 			{
				"name" : "arduivis_led.jpg",
				"bootpath" : "/Users/csKonopka-Tower/Desktop/=Repository=/arduivis/MaxMSP/Model1-Output",
				"patcherrelativepath" : ".",
				"type" : "JPEG",
				"implicit" : 1
			}
